...
#psyco.full()
import copy
print(aggdraw.__version__)


REFERENCE = Image.open('wenbo.png')
...
class Strain(object):
	...
	def draw(self):
		...
		draw.flush()
		s = draw.tobytes()
		return Image.frombytes('RGBA', IMAGE_SIZE, s)
...
if __name__ == "__main__":	
	...
	while True:
		...
		if best < last_img *0.9:
			last_img = best
			crossover_strains[0].draw().save("%s.png" % (crossover_strains[0].name))
